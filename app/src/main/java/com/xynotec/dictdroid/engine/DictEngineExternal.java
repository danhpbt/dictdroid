...
public class DictEngineExternal extends DictEngine
{
	RandomAccessFile fDic = null;
	
	public DictEngineExternal()
	{
...
//					break;
		...
		{
			Log.d("DictEngineExternal - OpenDict", ex.getMessage());
		}
	}
	...
	void ReadDataAtBlock(byte[] blockData, int block)
	{
		...
		{
			Log.d("DictEngineExternal - ReadDataAtBlock", ex.getMessage());						
		}
	}
