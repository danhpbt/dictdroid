...
public class CompareCzech extends CompareBase
{
	...
	public CompareCzech()
	{
		...
		charMap.put((char)0x010F, (char)(4 + minVal));	 
		charMap.put((char)0x010E, (char)(4 + minVal));	 
		...
		charMap.put((char)0x011B, (char)(5 + minVal));	 
		charMap.put((char)0x011A, (char)(5 + minVal));	 
		...
		//0063 0068 	Ch	 , (char)(9 + minVal));	 		
		//0043 0068 	CH	 , (char)(9 + minVal));	 
		//0043 0048			 , (char)(9 + minVal));	 
							 
		charMap.put((char)0x0069, (char)(10 + minVal));	 
		charMap.put((char)0x0049, (char)(10 + minVal));	 
		charMap.put((char)0x00ED, (char)(10 + minVal));	 
		charMap.put((char)0x00CD, (char)(10 + minVal));	 
		...
		charMap.put((char)0x0148, (char)(15 + minVal));	 
		charMap.put((char)0x0147, (char)(15 + minVal));	 
		...
		charMap.put((char)0x0070, (char)(17 + minVal));	 
		charMap.put((char)0x0050, (char)(17 + minVal));	 

		charMap.put((char)0x0071, (char)(18 + minVal));	 
		charMap.put((char)0x0051, (char)(18 + minVal));	 

		charMap.put((char)0x0072, (char)(19 + minVal));	 
		charMap.put((char)0x0052, (char)(19 + minVal));	 

		charMap.put((char)0x0159, (char)(20 + minVal));	 
		charMap.put((char)0x0158, (char)(20 + minVal));	 

		charMap.put((char)0x0073, (char)(21 + minVal));	 
		charMap.put((char)0x0053, (char)(21 + minVal));	 

		charMap.put((char)0x0161, (char)(22 + minVal));	 
		charMap.put((char)0x0160, (char)(22 + minVal));	 

		charMap.put((char)0x0074, (char)(23 + minVal));	 
		charMap.put((char)0x0054, (char)(23 + minVal));	 
		charMap.put((char)0x0165, (char)(23 + minVal));	 
		charMap.put((char)0x0164, (char)(23 + minVal));	 
		...
		charMap.put((char)0x016F, (char)(24 + minVal));	 
		charMap.put((char)0x016E, (char)(24 + minVal));	 

		charMap.put((char)0x0076, (char)(25 + minVal));	 
		charMap.put((char)0x0056, (char)(25 + minVal));	 

		charMap.put((char)0x0077, (char)(26 + minVal));	 
		charMap.put((char)0x0057, (char)(26 + minVal));	 
		...
		charMap.put((char)0x017E, (char)(30 + minVal));	 
		charMap.put((char)0x017D, (char)(30 + minVal));	
