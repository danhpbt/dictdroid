...
public class CompareEstonian extends CompareBase
{
	char[] charCollation = 
	{		
		0x0061,
	...
	public CompareEstonian()
	{
		...
		charMap.put((char)0x007A, (char)(20 + minVal));	 
		charMap.put((char)0x005A, (char)(20 + minVal));	 

		charMap.put((char)0x017E, (char)(21 + minVal));	 
		charMap.put((char)0x017D, (char)(21 + minVal));	 

		charMap.put((char)0x0074, (char)(22 + minVal));	 
		charMap.put((char)0x0054, (char)(22 + minVal));	 

		charMap.put((char)0x0075, (char)(23 + minVal));	 
		charMap.put((char)0x0055, (char)(23 + minVal));	 

		charMap.put((char)0x0076, (char)(24 + minVal));	 
		charMap.put((char)0x0056, (char)(24 + minVal));	 
		charMap.put((char)0x0077, (char)(24 + minVal));	 
		charMap.put((char)0x0057, (char)(24 + minVal));	 

		charMap.put((char)0x00F5, (char)(25 + minVal));	 
		charMap.put((char)0x00D5, (char)(25 + minVal));	 

		charMap.put((char)0x00E4, (char)(26 + minVal));	 
		charMap.put((char)0x00C4, (char)(26 + minVal));	 

		charMap.put((char)0x00F6, (char)(27 + minVal));	 
		charMap.put((char)0x00D6, (char)(27 + minVal));	 

		charMap.put((char)0x00FC, (char)(28 + minVal));	 
		charMap.put((char)0x00DC, (char)(28 + minVal));	 

		charMap.put((char)0x0078, (char)(29 + minVal));	 
		charMap.put((char)0x0058, (char)(29 + minVal));	 
