...
public class CompareFilipino extends CompareBase 
{
	char[] charCollation = 
	{
		0x0061,
	...
	public CompareFilipino()
	{
		...
		//charMap.put((char)0x006E 0067, (char)(15 + minVal)); 	Ng
		//charMap.put((char)0x004E 0067, (char)(15 + minVal)); 	NG
		//charMap.put((char)0x004E 0047, (char)(15 + minVal)
		...
		charMap.put((char)0x0073, (char)(20 + minVal)); 
		charMap.put((char)0x0053, (char)(20 + minVal));
	...
	protected String getComparableKey(String key)
	{
		...
		for (int i = 0; i < key_length; ++i) 
		{
			...
			if (bLookup)
			{
				...
				{
					case 0x006E:
						//0x006E 0067 15 + minVal); 
						if ((i + 1 < key_length) && (key.charAt(i + 1) == 0x0067))
						{
							sb.append((char)(15 + minVal));
							i++;
						}
						else
						{
					...
					case 0x004E:
						//0x004E 0067, 15 + minVal);
						//0x004E 0047, 15 + minVal)
						if ((i + 1 < key_length) && ((key.charAt(i + 1) == 0x0067) || (key.charAt(i + 1) == 0x0047)))
						{
							sb.append((char)(15 + minVal));
							i++;
						}
