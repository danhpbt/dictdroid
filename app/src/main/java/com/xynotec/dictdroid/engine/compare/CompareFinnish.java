...
public class CompareFinnish extends CompareBase
{
	char[] charCollation = 
	{	
		0x0061,
	...
	public CompareFinnish()
	{
		...
		charMap.put((char)0x0161, (char)(18 + minVal));	
		charMap.put((char)0x0160, (char)(18 + minVal));	
		...
		charMap.put((char)0x0077, (char)(21 + minVal));	
		charMap.put((char)0x0057, (char)(21 + minVal));	

		charMap.put((char)0x0078, (char)(22 + minVal));	
		charMap.put((char)0x0058, (char)(22 + minVal));	

		charMap.put((char)0x0079, (char)(23 + minVal));	
		charMap.put((char)0x0059, (char)(23 + minVal));	

		charMap.put((char)0x007A, (char)(24 + minVal));	
		charMap.put((char)0x005A, (char)(24 + minVal));	
		charMap.put((char)0x017E, (char)(24 + minVal));	
		charMap.put((char)0x017D, (char)(24 + minVal));	

		charMap.put((char)0x00E5, (char)(25 + minVal));	
		charMap.put((char)0x00C5, (char)(25 + minVal));	
