...
public class CompareFrench extends CompareBase
{
	char[] charCollation = 
	{	
		0x0061,
	...
	public CompareFrench()
	{
		...
		charMap.put((char)0x00E6, (char)(0 + minVal)); 	
		charMap.put((char)0x00C6, (char)(0 + minVal));
		...
		charMap.put((char)0x00E8, (char)(4 + minVal));  	
		charMap.put((char)0x00C8, (char)(4 + minVal));  	
		...
		charMap.put((char)0x00EE, (char)(8 + minVal));  	
		charMap.put((char)0x00CE, (char)(8 + minVal));  	
		...
		charMap.put((char)0x0153, (char)(14 + minVal));  	
		charMap.put((char)0x0152, (char)(14 + minVal)); 
		...
		charMap.put((char)0x00F9, (char)(20 + minVal));  	
		charMap.put((char)0x00D9, (char)(20 + minVal));  	
		charMap.put((char)0x00FB, (char)(20 + minVal));  	
		charMap.put((char)0x00DB, (char)(20 + minVal));  	
		...
		charMap.put((char)0x00FF, (char)(24 + minVal));  	
		charMap.put((char)0x0178, (char)(24 + minVal)); 
