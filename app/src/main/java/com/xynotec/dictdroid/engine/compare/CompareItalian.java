...
public class CompareItalian extends CompareBase
{
	char[] charCollation = 
	{	
		0x0061,
	...
	public CompareItalian()
	{
		...
		charMap.put((char)0x00EC, (char)(8 + minVal)); 
		charMap.put((char)0x00CC, (char)(8 + minVal));
		...
		charMap.put((char)0x00F2, (char)(14 + minVal)); 
		charMap.put((char)0x00D2, (char)(14 + minVal));
